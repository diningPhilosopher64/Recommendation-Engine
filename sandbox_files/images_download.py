#This script is for downloading images from IMDB, as there only so many requests IMDB will let me do

#6765 dont mind this

#file_path is the path you need to give to save images(the folder must exist , this script doesnt create one)

#movies_file is the path to movies.csv dataset
